...
public class CssCompressMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		String[] exts = new String[] { "css" };
		Collection<File> files = FileUtils.listFiles(sourceDirectory, exts,
				true);
	...
	private void compress(File inFile) throws Exception {
